...
export const ui = {
	en: {
		...
		"page.home.features.decentralized.body": "In HLA, Mapping layers are built as self-contained web applications.",
		"page.home.features.tiling.title": "Advanced Tiling",
		"page.home.features.tiling.body": "HLA offers a highly performant tiling system, able to handle large scale mapping data with ease.",
		"page.home.features.open-source.title": "Open Source",
		"page.home.features.open-source.body": "HLA is a fully open-source project that is actively maintained and has been used by enterprises for 15+ years.",
	...
	ja: {
		...
		"page.home.features.decentralized.body": "HLAでは、マッピングレイヤーは独立したWebアプリケーションとして構築されます。",
		"page.home.features.tiling.title": "高度なタイル配置",
		"page.home.features.tiling.body": "HLAは、大規模な地図データを容易に処理できる、高性能なタイリングシステムを提供しています。",
		"page.home.features.open-source.title": "オープンソース",
		"page.home.features.open-source.body": "HLAは、積極的にメンテナンスが行われている完全なオープンソースプロジェクトであり、15年以上にわたり企業で利用されてきました。",
